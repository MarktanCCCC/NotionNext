...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Marktan', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个干营销策划的人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.burnlife.cn', // 网站地址
